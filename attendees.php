...
<body style="background-image: url('./image/carpool.jpg'); background-repeat: no-repeat; background-size: cover;">
  ...
  <section>
    ...
    <form method="post">
      ...
      <input type="number" attendee_id="attendee_id" name="attendee_id"><br><br>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $connection->prepare("INSERT INTO attendees (attendee_id, user_id, class_id) VALUES ( ?, ?, ?)");
        $stmt->bind_param("iss", $attendee_id, $user_id, $class_id);
